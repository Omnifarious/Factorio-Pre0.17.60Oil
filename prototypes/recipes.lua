...
if settings.startup["pre0-17-60oil-revert-flamethrowerammo"].value then
...
if settings.startup["pre0-17-60oil-revert-advoilrecipe"].value then
...
if settings.startup["pre0-17-60oil-revert-rocketfuelrecipe"].value then
